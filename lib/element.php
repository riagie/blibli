...
define('VOUCHERS_ERR3', "0 voucher/kode promo terpakai");
define('VOUCHERS_ERR4', "telah mencapai batas maksimum jumlah penukaran");
define('VOUCHERS_ERR5', "Pastikan kode promo yang kamu masukkan benar");
define('VOUCHERS_DEL', "//button[@class='blu-btn applied-voucher-summary__button b-white b-small']");
define('VOUCHERS_DEL2', "//div[@class='applied-voucher applied-voucher-modal__voucher success']");
define('VOUCHERS_DEL3', "//button[@class='blu-btn b-danger']");
...
define('PAYMENT_METHOD_ERR', "Kartu kredit / debit");
define('PAYMENT_METHOD_IN', "//b[@class='payment-type-name ng-binding']");
define('Kartu_Kredit_Debit', "document.querySelector('#gdn-payment-list > li:nth-child(3)').click();");
define('Non_Kartu_Kredit_Debit', "document.querySelector('#gdn-payment-list > li:nth-child(2)').click();");
...
define('THANKYOU2', "Selesaikan pembayaran dalam");
